        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="values">
              <sld:ColorMapEntry color="#000000" opacity="0" quantity="0" label="背景"/>
              <sld:ColorMapEntry color="#ffd37f" quantity="1" label="高风险"/>
              <sld:ColorMapEntry color="#e64c00" quantity="2" label="极高风险"/>
            </sld:ColorMap>
            <sld:ContrastEnhancement/>
          </sld:RasterSymbolizer>
        </sld:Rule>
